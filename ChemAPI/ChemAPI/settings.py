"""
Django settings for ChemAPI project.
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR
            + "/templates/",  # this allow render template at each individual app
        ],
...
WSGI_APPLICATION = "ChemAPI.wsgi.application"
